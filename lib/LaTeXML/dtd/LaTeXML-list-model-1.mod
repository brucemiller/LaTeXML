...
<!ATTLIST %LaTeXML.itemize.qname; %LaTeXML.Common.attrib;>

<!ELEMENT %LaTeXML.enumerate.qname; (%LaTeXML.item.qname;)*>
<!ATTLIST %LaTeXML.enumerate.qname; %LaTeXML.Common.attrib;>

<!ELEMENT %LaTeXML.description.qname; (%LaTeXML.item.qname;)*>
<!ATTLIST %LaTeXML.description.qname; %LaTeXML.Common.attrib;>

<!ELEMENT %LaTeXML.item.qname; (%LaTeXML.Block.mix; | %LaTeXML.tag.qname;)*>
<!ATTLIST %LaTeXML.item.qname; %LaTeXML.Common.attrib;>
