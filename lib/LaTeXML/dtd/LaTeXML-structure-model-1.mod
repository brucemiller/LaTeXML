...
<!--%
     @role indicates the role of the person in creating the docment.
...
<!--%
    @role indicates the type of contact information contained.
...
<!--%
    @role indicates the relevance of the date to the document.
