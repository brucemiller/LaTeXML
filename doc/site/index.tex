...
repository (thanks Sean, Andrew Fernandes).

Since some users prefer \href{http://tug.org/mactex/}{MacTeX} or another
\TeX\ system over MacPort's \texttt{texlive},
the \LaTeXML\ Portfile does \emph{not} include a dependency on a \TeX-installation!
However, you really should pre-install either MacTeX or a system of your choice,
