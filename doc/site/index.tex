...
Other
   ...
   & see \htmlref{CPAN}{install.cpan.prereq} \\
\end{tabular}
...
The following packages are usually desirable, but aren't strictly required.
\begin{description}
\item[\TeX] Most users of \LaTeXML\ will want to install \TeX.  \LaTeXML\ 
...
\begin{itemize}
\item Download \CurrentFedora\ or \CurrentRedHat, as appropriate.
...
\paragraph{Installing prebuilt}
\emph{LaTeXML 0.8.0 will be soon be available in the Debian repositories!}
...
sudo apt-get install   \
  ...
  texlive imagemagick perlmagick 
\end{lstlisting}
...
cpan Archive::Zip DB_File File::Which Image::Size \
  IO::String libwww JSON::XS LWP Parse::RecDescent \
