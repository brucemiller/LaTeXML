...
\newcommand{\showunit}[1]{#1 & \texttt{\Backslash#1} & \si{\csname#1\endcsname}}
Non-SI units whose values in SI units must be obtained experimentally
(that are deprecated in siunitx v3, but make sure we still have them):
\begin{center}
