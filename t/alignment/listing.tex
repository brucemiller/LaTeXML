...
\begin{lstlisting}[language=Pascal,caption=A bit of Pascal, label=pascallisting,firstnumber=100,numbers=left]
for i:=maxint to 0 do
begin
  { do nothing }
end;
...
\begin{lstlisting}[language=c,escapechar=\%,escapebegin=<,escapeend=>,numbers=left]
// calculate %$a_{ij}$%
a_{ij}
 = a_{jj}/a{ij};
\end{lstlisting}
