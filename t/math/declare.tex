...
\section{Euler's Identity: Backporting Semantics}
\lxDefMath{\cpi}{\pi}[meaning={Circular pi}]
\lxDefMath{\iunit}{\mathrm{i}}[meaning={Imaginary unit}]
\lxDefMath{\expe}{\mathrm{e}}[meaning={Exponential e}]
\lxDeclare[scope=section,replace=$\cpi$]{$\pi$}
\lxDeclare[scope=section,replace=$\iunit$]{$i$}
\lxDeclare[scope=section,replace=$\expe$]{$e$}
\[  e^{i\pi} + 1 = 0 \]
\end{document}
